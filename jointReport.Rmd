...
```{r}
data <- read_xlsx("~/GitHub/set_sDcDq/data/data.xlsx") # This reads sheet 1, which is the right one for experiment 1
```
...
# Compare d values
d1 <- tes(t = test1$statistic, n.1 = length(data$score[data$age == 3 & data$condition == 1]), n.2 = length(data$score[data$age == 3 & data$condition == 2]))
